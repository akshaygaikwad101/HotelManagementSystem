...
public class AddCustomer  extends JFrame implements ActionListener{
    ...
    AddCustomer(){
        ...
        text.setFont(new Font("Railway",Font.TRUETYPE_FONT,20));
        add(text);
        ...
        String options[]={"Aadhar Card","Passport","Driving licence","VoterId","Ration Card"};
        ...
        checkintime.setBounds(205,320,160,20);
