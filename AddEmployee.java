...
public class AddEmployee extends JFrame implements ActionListener {
    ...
    JLabel lblname,lblage,lblgender,lbljob,lblsalary,lblphone,lblemail,lblaadhar;
    JComboBox cbjob;
    JButton submit;
    ...
    AddEmployee(){
        ...
        rbmale.setFont(new Font("Railway",Font.PLAIN,14));
        rbmale.setBackground(Color.WHITE);
        add(rbmale);
        
        rbfemale=new JRadioButton("FEMALE");
        rbfemale.setBounds(280,130,80,30);
        rbfemale.setFont(new Font("Railway",Font.PLAIN,14));
        ...
        String str[]={"Front Desk Clerk","Porters","Room Service","Waiter","Manager","Chefs","Accountant"};
        ...
        image.setBounds(380,40,430,370);
        image.setForeground(Color.CYAN);
        add(image);
